...
let face = "mask that someone shows others"; /*Between the quotation marks, 
...
let red = "danger, blood, rush"; //repeat the instructions with the word "red" (keep in the form of a noun)

let brain = "smart, information, a safe"; //repeat the instructions for the word "brain"

let masculine = "cut of emtionally"; //define 'masculine' in ADJECCTIVE form, so 
//you could sub it into a sentence that uses the word as an ADJECTIVE

let think = "contemplate"; //define 'think' in VERB form,
